...
# Get number of features of the last linear layer
...
for epoch in range(epochs):
    ...
    if val_acc > best_acc:
        best_acc = val_acc
        best_epoch = epoch + 1
        torch.save(model.state_dict(), "checkpoints/shufflenet_v2_x1_0_state_dict.ckpt")
...
model.load_state_dict(torch.load("checkpoints/shufflenet_v2_x1_0_state_dict.ckpt"))
model.eval()
