...
ckpt_path = "checkpoints/mobilenetv2_state_dict.ckpt"
...
num_classes = len(os.listdir("training_aug"))  # assumes training_aug/<class_folders>
...
class_names = sorted(os.listdir("training_aug"))
...
for img_file in os.listdir(img_dir):
    if img_file.lower().endswith((".jpg", ".jpeg", ".png")):
        ...
        print(f"🖼️ {img_file}     predicted --> {pred_class}  (time: {elapsed_ms:.2f} ms)")
