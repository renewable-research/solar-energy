...
#🔹 EfficientNet-B1 Parameters:
#Backbone params   : 6.51 M
#Classifier params : 0.66 M
#Total params      : 7.17 M
...
ckpt_path = "checkpoints/efficientnet_b1_state_dict.ckpt"  # trained model weights
...
num_features = model.classifier.in_features  # get input features of last layer
...
backbone_params = count_params(model) - count_params(model.classifier)
