...
ckpt_path = "checkpoints/resnet18_state_dict.ckpt"  # trained model weights
...
# Backbone (everything except the last fc layer)
backbone_params = count_params(nn.Sequential(
    model.conv1,
    model.bn1,
    model.relu,
    model.maxpool,
