...
# Replace the classifier (fc layer) with custom head
...
for epoch in range(epochs):
    ...
    if val_acc > best_acc:
        best_acc = val_acc
        best_epoch = epoch + 1
        torch.save(model.state_dict(), "checkpoints/googlenet_state_dict.ckpt")
...
model.load_state_dict(torch.load("checkpoints/googlenet_state_dict.ckpt"))
model.eval()
